...
// Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that 
// contains information about the runners that have a shirt size of L and log the result
let largeShirts = [];
...
// and the 5k fun run theme.  Try to create and then solve 3 unique problems using one or many 
// of the array methods listed above.
...
runners.forEach(function(currentValue){
    alphaLast.push(currentValue.last_name);
})
alphaLast.sort();

console.log(alphaLast);

// Problem 2: add total donation

const donationTot = runners.reduce((accumulator,currentValue) => {

    return accumulator + currentValue.donation;

}, 0); 

console.log(donationTot);

// Problem 3: Grab all the emails

const runnerEmails = runners.map(function(currentValue){
